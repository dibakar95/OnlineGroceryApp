...
import {getHeight, getWidth} from './pixel-resolver';
...
export const Metrics = {
  ...
  marginHorizontal: 10,
  marginVertical: 10,
  navBarHeight: DeviceInfo.hasNotch()
    ? getHeight(88)
    : Platform.OS === 'android'
    ? getHeight(45)
    : getHeight(68),
...
export const heightDependentSize = size => (height / 700) * size;
export const widthDependentSize = size => (width / 400) * size;
